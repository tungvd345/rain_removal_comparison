...
parser.add_argument('--dataroot', required=False, default='D:/DATASETS/Heavy_rain_image_cvpr2019/train_301_350/pix2pix', help='path to trn dataset')
# parser.add_argument('--dataroot', required=False, default='./facades/validation', help='path to trn dataset')
parser.add_argument('--valDataroot', required=False, default='D:/DATASETS/Heavy_rain_image_cvpr2019/val_301_350/pix2pix', help='path to val dataset')
...
if __name__ == '__main__':
  ...
  val_input_cpu, val_target_cpu, label_val = data_val
      ...
      if ganIterations % opt.evalIter == 0:
        ...
        for idx in range(val_input.size(0)):
          ...
          with torch.no_grad():
              ...
              val_targetv = Variable(target_img)
