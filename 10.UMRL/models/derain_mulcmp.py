...
class UMRL(nn.Module):
    ...
    def forward(self, x,x_256,x_128):
        ...
        b, c, h_x1, w_x1 = x1.shape

        ###  32x32
        x2=(self.dense_block2(x1))
        x2=self.trans_block2(x2)
        b, c, h_x2, w_x2 = x2.shape
        #print x2.size()
        ### 16 X 16
        x3=(self.dense_block3(x2))
        x3=self.trans_block3(x3)
        b, c, h_x3, w_x3 = x3.shape
        ...
        x5 = self.upsample(x5, size=(h_x1, w_x1))
        ...
        residual=self.upsample(residual, size=(x.shape[2], x.shape[3]))
