...
parser.add_argument('--valDataroot', required=False, default='C:/DATASETS/real_rain/pix2pix', help='path to val dataset')
...
parser.add_argument('--netG', default='./check_50epoch_HR/UMRL_epoch_49.pth', help="path to netG (to continue training)")
        ...
        if 1:
          ...
          with torch.no_grad():
            for idx in range(val_input.size(0)):
                ...
                filename = './result_all/umrl_fu/' + image_name  # str(i)+'.png'
