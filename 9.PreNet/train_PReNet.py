...
parser.add_argument("--save_path", type=str, default="logs/HeavyRain/PReNet1e-5_HR", help='path to save models and log files')
parser.add_argument("--save_freq",type=int,default=1,help='save intermediate model')
parser.add_argument("--data_path",type=str, default="D:/DATASETS/Heavy_rain_image_cvpr2019/train_301_350",help='path to training data')
parser.add_argument("--data_name",type=str, default="Rain100H",help='name training data')
...
def set_lr(opt, epoch, optimizer):
    lrDecay = 50
    k = 1 / lrDecay
    lr = opt.lr / (1 + k * epoch)
...
def main():
    ...
    for epoch in range(initial_epoch, opt.epochs):
        ...
        # for i, (input_train, target_train) in enumerate(loader_train):
            ...
            step += 1
        psnr_epoch = psnr_epoch / 459 # 459=(num file / batch size)
        print('[epoch %d] PSNR: %.4f' %(epoch+1,psnr_epoch))
        ## epoch training end
