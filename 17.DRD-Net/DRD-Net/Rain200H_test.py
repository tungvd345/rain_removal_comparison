...
def get_args():
    ...
    # parser.add_argument("--image_dir_rain", type=str, default='D:/DATASETS/Heavy_rain_image_cvpr2019/test_with_train_param_v5/in',
    parser.add_argument("--image_dir_rain", type=str, default='D:/DATASETS/real_rain/new/in',
    # parser.add_argument("--image_dir_rain", type=str, default='D:/DATASETS/JORDER_DATASET/test/R100H_prev/rain',
                        help="rain image dir")
    # parser.add_argument("--image_dir_gt", type=str, default='D:/DATASETS/Heavy_rain_image_cvpr2019/test_with_train_param_v5/gt',
    parser.add_argument("--image_dir_gt", type=str, default='D:/DATASETS/JORDER_DATASET/test/R100H_prev/norain',
                        help="gt image dir")
    parser.add_argument("--model", type=str, default="the_end",
                        help="model architecture ")
    parser.add_argument("--weight_file", type=str, default='./weights/Outdoor-Rain/weights.089-0.006-23.53223.hdf5', help="trained weight file")
    # parser.add_argument("--weight_file", type=str, default='./weights/Rain100H/weights.115-0.002-28.08799.hdf5', help="trained weight file")
