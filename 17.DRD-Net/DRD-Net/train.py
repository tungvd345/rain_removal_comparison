...
def get_args():
    ...
    # parser.add_argument("--image_dir_noise", type=str, default='D:/DATASETS/Heavy_rain_image_cvpr2019/train_301_350/in',
    parser.add_argument("--image_dir_noise", type=str, default='D:/DATASETS/JORDER_DATASET/train/rain_data_train_Heavy/rain',
                        help="train image dir")
    # parser.add_argument("--image_dir_original", type=str, default='D:/DATASETS/Heavy_rain_image_cvpr2019/train_301_350/gt',
    parser.add_argument("--image_dir_original", type=str, default='D:/DATASETS/JORDER_DATASET/train/rain_data_train_Heavy/norain',
                        help="train image dir")
    # parser.add_argument("--test_dir_noise", type=str, default='D:/DATASETS/Heavy_rain_image_cvpr2019/val_301_350/in',
    parser.add_argument("--test_dir_noise", type=str, default='D:/DATASETS/JORDER_DATASET/test/R100H_prev/rain',
                        help="test image dir")
    # parser.add_argument("--test_dir_original", type=str, default='D:/DATASETS/Heavy_rain_image_cvpr2019/val_301_350/gt',
    parser.add_argument("--test_dir_original", type=str, default='D:/DATASETS/JORDER_DATASET/test/R100H_prev/norain',
                        help="test image dir")
