...
#root = os.path.join(test_raincityscapes_path, 'in')

root = 'C:/DATASETS/Heavy_rain_image_cvpr2019/test_with_train_param_v5/in/'
...
def main():
    ...
    net.eval()
    # print('num of param 1:', count_parameters(net))
    avg_time = 0
    total_time = 0
    ...
    with torch.no_grad():
        ...
        for idx, img_name in enumerate(img_list):
            ...
            #res, dps = net(img_var)
            res = net(img_var)
            # print('num of param 2:', count_parameters(net))
