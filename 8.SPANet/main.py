...
class Session:
    def __init__(self):
        ...
        self.log_dir = './logdir_HR'
        self.model_dir = './model_HR'
        ...
        # self.test_data_path = 'D:/DATASETS/Heavy_rain_image_cvpr2019/LRBI/test_with_train_param_v5' # data path to test dataset
        # self.train_data_path = 'D:/DATASETS/Heavy_rain_image_cvpr2019/LRBI/train'                   # data path to train dataset
        # self.val_data_path = 'D:/DATASETS/Heavy_rain_image_cvpr2019/LRBI/val'                       # data path to val dataset
        self.test_data_path = 'D:/DATASETS/real_rain/new'  # data path to real test dataset
        # self.test_data_path = 'C:/DATASETS/Heavy_rain_image_cvpr2019/test_with_train_param_v5'  # data path to test dataset
        self.train_data_path = 'C:/DATASETS/Heavy_rain_image_cvpr2019/train_301_350'  # data path to train dataset
        self.val_data_path = 'C:/DATASETS/Heavy_rain_image_cvpr2019/val_301_350'  # data path to val dataset
...
def run_test(ckp_name):
    ...
    for i, batch in enumerate(dt):
        ...
        ensure_dir('./test/pred')
        ensure_dir('./test/mask')
        file_name = batch['name']
        cv2.imwrite('./test/pred/%s'%file_name[0], pred)
        cv2.imwrite('./test/mask/m_%s'%file_name[0], mask)
        bar.update(i+1)
